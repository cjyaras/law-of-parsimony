...
axes[0].plot(original_result['test_loss'], linewidth=6, label='Original')
axes[0].plot(comp_result['test_loss'], linewidth=3, label='CompDMF')
axes[0].plot(narrow_r_result['test_loss'], linewidth=3, label='Width=$r$')
axes[0].plot(narrow_2r_result['test_loss'], linewidth=3, label='Width=$2r$')
...
axes[1].plot(original_result['time'], original_result['test_loss'], linewidth=4, label='Original')
axes[1].plot(comp_result['time'], comp_result['test_loss'], linewidth=4, label='CompDMF')
axes[1].plot(narrow_r_result['time'], narrow_r_result['test_loss'], linewidth=4, label='Width=$r$')
axes[1].plot(narrow_2r_result['time'], narrow_2r_result['test_loss'], linewidth=4, label='Width=$2r$')
